                    ...
                    <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right">
                        <ul class="manageList">`
                            ...
                            <a class="navigationLink">
                                <em class="navigationLink-icon fa fa-ban"></em>
                                <span class="" action-type = 'toggle-status'>Deactivate</span>
                            </a>
                        </li>`
                        :`<li class="list">
                                <a  class="navigationLink">
                                    <em class="navigationLink-icon fa fa-check"></em>
                            ...
                            +`<li class="list">
                                <a class="navigationLink">
                                    <em class="navigationLink-icon fa fa-edit"></em>
                                    <span class="" action-type='edit'> Edit</span>
                                </a>
                            </li>
                            <li class="list">
                                <a class="navigationLink">
                                    <em class="navigationLink-icon fa fa-file"></em>
                            ...
                            <li class="list">
                            <a class="navigationLink">
                                <em class="navigationLink-icon fa fa-trash"></em>
